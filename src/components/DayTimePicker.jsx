...
const propTypes = forbidExtraProps({
  ...
  // gauge customization - date props
  startDate: momentPropTypes.momentObj,
  endDate: momentPropTypes.momentObj,

  // gauge customization - time props
...
export default class DayTimePicker extends React.Component {
  constructor(props) {
    ...
    this.state = {
      currentMonth: props.hidden ? moment() : props.initialVisibleMonth(), // gauge customization
